...
#include "custom_pkg/srv/hss.hpp"                                     
...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<custom_pkg::srv::Hss>::SharedPtr client =                
    node->create_client<custom_pkg::srv::Hss>("add_three_ints");          

  auto request = std::make_shared<custom_pkg::srv::Hss::Request>();       
